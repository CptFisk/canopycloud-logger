...
getVariantHandlers() {
    static const std::unordered_map<const UA_DataType*, VariantHandler> handlers = {
        ...
        { &UA_TYPES[UA_TYPES_SBYTE], [](const UA_Variant& v, BaseTag& tag) { tag.value = *static_cast<int8_t*>(v.data); } },
        { &UA_TYPES[UA_TYPES_BYTE], [](const UA_Variant& v, BaseTag& tag) { tag.value = *static_cast<uint8_t*>(v.data); } },
        { &UA_TYPES[UA_TYPES_INT16], [](const UA_Variant& v, BaseTag& tag) { tag.value = *static_cast<int16_t*>(v.data); } },
        { &UA_TYPES[UA_TYPES_UINT16], [](const UA_Variant& v, BaseTag& tag) { tag.value = *static_cast<uint16_t*>(v.data); } },
        { &UA_TYPES[UA_TYPES_INT32], [](const UA_Variant& v, BaseTag& tag) { tag.value = *static_cast<int32_t*>(v.data); } },
        { &UA_TYPES[UA_TYPES_UINT32], [](const UA_Variant& v, BaseTag& tag) { tag.value = *static_cast<uint32_t*>(v.data); } },
        { &UA_TYPES[UA_TYPES_FLOAT], [](const UA_Variant& v, BaseTag& tag) { tag.value = *static_cast<float*>(v.data); } },
        { &UA_TYPES[UA_TYPES_DOUBLE], [](const UA_Variant& v, BaseTag& tag) { tag.value = *static_cast<double*>(v.data); } },
